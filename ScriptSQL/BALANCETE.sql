...
SET @DT_INI = '2016-01-01'
SET @DT_FIM = '2019-12-31'
            
			
		SELECT BALANCETE.Grupo, BALANCETE.SubGrupo, BALANCETE.Financeiro, BALANCETE.Economico, BALANCETE.Contabil, BALANCETE.SaldoInicial, BALANCETE.Debito, BALANCETE.Credito, SUM(BALANCETE.SaldoInicial + BALANCETE.Debito - BALANCETE.Credito) As SaldoFinal FROM 
		(
		 ...
		 GROUP BY BALANCETE.Grupo, BALANCETE.SubGrupo, BALANCETE.Financeiro, BALANCETE.Economico, BALANCETE.Contabil, BALANCETE.SaldoInicial, BALANCETE.Debito, BALANCETE.Credito